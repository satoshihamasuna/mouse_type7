...
const static t_turn_param_table slalom_L180_2000_table = {2.00f, 50.50f,8.80,30.10, 180.0f,Turn_L};
const static t_turn_param_table slalom_R180_2000_table = {2.00f,-50.50f,8.80,30.10,-180.0f,Turn_R};
