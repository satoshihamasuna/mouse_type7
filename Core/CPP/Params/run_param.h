...
const static t_pid_gain sp_gain_turn90_1000 = {10.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turn180_1000 = {10.0, 0.05, 0.00};
...
//not adjust
const static t_pid_gain sp_gain_turnV90_1000 = {10.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turnIn45_1000 = {10.0, 0.05, 0.00};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1000 = {10.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turnIn135_1000 = {10.0, 0.05, 0.00};
...
//
const static t_pid_gain sp_gain_turnOut135_1000 = {10.0, 0.05, 0.0};
...
const static t_pid_gain sp_gain_turn90_1200 = {10.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turn180_1200 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turn180_1200 = {0.4, 0.01, 0.0};
...
//not adjust
const static t_pid_gain sp_gain_turnV90_1200 = {10.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turnIn45_1200 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnIn45_1200 = {0.4, 0.01, 0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1200 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut45_1200 = {0.4, 0.01, 0.0};
...
const static t_pid_gain sp_gain_turnIn135_1200 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnIn135_1200 = {0.4, 0.01, 0.0};//{0.7f, 0.7f, 0.0f};
...
//
const static t_pid_gain sp_gain_turnOut135_1200 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut135_1200 = {0.4, 0.01, 0.0};
...
const static t_pid_gain om_gain_turnV90_1400 = {0.3, 0.005, 0.0};
...
const static t_pid_gain om_gain_turnIn45_1400 = {0.3, 0.005, 0.0};
...
const static t_pid_gain om_gain_turnOut45_1400 = {0.3, 0.005, 0.0};
...
const static t_pid_gain om_gain_turnIn135_1400 = {0.4, 0.05, 0.0};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1400 = {0.4, 0.05, 0.0};
...
const static t_pid_gain sp_gain_turn90_1600 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turn90_1600 = {0.4, 0.05, 0.0};
...
const static t_pid_gain sp_gain_turn180_1600 = {10.0, 0.05, 0.00};
...
//k = 300
//not adjust
const static t_pid_gain sp_gain_turnV90_1600 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnV90_1600 = {0.4, 0.05, 0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnIn45_1600 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnIn45_1600 = {0.4, 0.05, 0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1600 = {10.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut45_1600 = {0.4, 0.05, 0.0};
...
const static t_pid_gain sp_gain_turnIn135_1600 = {10.0, 0.05, 0.0};
const static t_pid_gain om_gain_turnIn135_1600 = {0.4, 0.05, 0.0};//{0.7f, 0.7f, 0.0f};
...
const static t_pid_gain om_gain_turnOut135_1600 = {0.4, 0.05, 0.0};
