...
const static t_pid_gain sp_gain_300 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_320 = {12.0, 0.05, 0.0};
...
const static t_pid_gain sp_gain_450 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_600 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_700 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_1000 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_1050 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1100 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1200 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1300 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1400 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1500 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1600 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1700 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1800 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_1900 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2000 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2100 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2200 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2300 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2400 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2500 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2600 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2700 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2800 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_2900 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_3000 = {12.0,0.04,0.0};
...
const static t_pid_gain sp_gain_3200 = {20.0,0.04,0.0};
...
const static t_pid_gain sp_gain_3400 = {20.0,0.04,0.0};
...
const static t_pid_gain sp_gain_turn90_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turn180_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turnV90_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turnIn45_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turnOut45_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turnIn135_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turnOut135_500 = {16.0,0.1,0.2};
...
const static t_pid_gain sp_gain_turn90_1200 = {20.0, 0.01, 0.0};
...
const static t_pid_gain sp_gain_turn180_1200 = {20.0, 0.01, 0.0};
...
//not adjust
const static t_pid_gain sp_gain_turnV90_1200 = {20.0, 0.01, 0.0};
...
const static t_pid_gain sp_gain_turnIn45_1200 = {20.0, 0.01, 0.0};
...
//k = 300
const static t_pid_gain sp_gain_turnOut45_1200 = {20.0, 0.01, 0.0};
...
const static t_pid_gain sp_gain_turnIn135_1200 = {20.0, 0.01, 0.0};
...
//
const static t_pid_gain sp_gain_turnOut135_1200 = {20.0, 0.01, 0.0};
...
//k = 250
const static t_pid_gain sp_gain_turn90_1400 = {12.0, 0.05, 0.00};
...
const static t_pid_gain sp_gain_turn180_1400 = {12.0, 0.05, 0.00};
...
//not adjust
const static t_pid_gain sp_gain_turnV90_1400 = {12.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnV90_1400 = {0.8, 0.05, 0.0};
...
const static t_turn_param_table slalom_LV90_1400_table = {1.40f, 42.0f,6.73,22.99, 90.0f,Turn_L};
const static t_turn_param_table slalom_RV90_1400_table = {1.40f,-42.0f,6.37,22.99,-90.0f,Turn_R};
...
//
const static t_pid_gain sp_gain_turnIn45_1400 = {12.0, 0.054, 0.00};
const static t_pid_gain om_gain_turnIn45_1400 = {0.6, 0.05, 0.02};
const static t_turn_param_table slalom_inL45_1400_table = {1.40f, 55.0f,8.28,40.77, 45.0f,Turn_L};
...
//k = 220
const static t_pid_gain sp_gain_turnOut45_1400 = {12.0, 0.05, 0.00};
const static t_pid_gain om_gain_turnOut45_1400 = {0.6, 0.05, 0.005};
...
const static t_pid_gain sp_gain_turnIn135_1600 = {12.0, 0.05, 0.0};
...
const static t_pid_gain om_gain_turnV90_1500 = {0.8, 0.05, 0.0};
const static t_turn_param_table slalom_LV90_1500_table = {1.50f, 42.50f,5.96,23.43, 90.0f,Turn_L};
const static t_turn_param_table slalom_RV90_1500_table = {1.50f,-42.50f,5.96,23.43,-90.0f,Turn_R};
...
const static t_pid_gain om_gain_turnIn45_1500 = {0.8, 0.05, 0.0};
...
const static t_pid_gain om_gain_turnOut45_1500 = {0.8, 0.05, 0.0};
...
const static t_pid_gain om_gain_turnIn135_1500 = {0.6, 0.05, 0.0};//{0.7f, 0.7f, 0.0f};
const static t_turn_param_table slalom_inL135_1500_table = {1.50f, 44.0f,17.09,29.64, 135.0f,Turn_L};
const static t_turn_param_table slalom_inR135_1500_table = {1.50f,-44.0f,17.09,29.64,-135.0f,Turn_R};
...
const static t_pid_gain om_gain_turnOut135_1500 = {0.6, 0.05, 0.0};
const static t_turn_param_table slalom_outL135_1500_table = {1.50f, 44.0f,9.47,37.43, 135.0f,Turn_L};
const static t_turn_param_table slalom_outR135_1500_table = {1.50f,-44.0f,9.47,37.43,-135.0f,Turn_R};
